...
class BasicAbstractGame : public Game {
  public:
    ...
    virtual std::shared_ptr<QImage> segment_asset(std::shared_ptr<QImage> asset_ptr, int base_type, int theme);
    ...
    void color_asset(std::shared_ptr<QImage> asset, int r, int g, int b);
  ...
  protected:
    ...
    std::shared_ptr<QImage> black_bg_image;
