...
void Game::observe() {
    ...
    *(int32_t *)(info_bufs[info_name_to_offset.at("max_possible_score")]) = (int32_t)(max_possible_score);
    *(int32_t *)(info_bufs[info_name_to_offset.at("min_possible_score")]) = (int32_t)(min_possible_score);
}
...
void Game::serialize(WriteBuffer *b) {
    ...
    b->write_int(max_possible_score);
    b->write_int(min_possible_score);
...
void Game::deserialize(ReadBuffer *b) {
    ...
    max_possible_score = b->read_int();
    min_possible_score = b->read_int();
