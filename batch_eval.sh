...
do
  ...
  CUDA_VISIBLE_DEVICES=6 python eval_model.py --env_name $GM --experiment_name semantic_p1_r1 --BASE_PATH /media/data_cifs/projects/prj_procgen/lax/prj-taxRL/train-procgen/train_procgen/results --vision_mode normal --stochasticity 1. --output semantic_on_pixels
done
